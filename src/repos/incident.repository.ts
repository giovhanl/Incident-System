...
import {
  IncidentDetailDocument,
  IncidentMaster,
  IncidentDetail,
  IncidentMasterDocument,
...
export class IncidentMasterRepository extends EntityRepository<IncidentMasterDocument> {
  constructor(
    @InjectModel(IncidentMaster.name) incidentm: Model<IncidentMasterDocument>,
  ) {
    super(incidentm);
  }
}
...
export class IncidentDetailRepository extends EntityRepository<IncidentDetailDocument> {
  constructor(
    @InjectModel(IncidentDetail.name) incidentd: Model<IncidentDetailDocument>,
  ) {
    super(incidentd);
  }
}
